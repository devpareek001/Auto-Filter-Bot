...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8786244674 8385589427').split()] 
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Dev_files')
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'Dev'))
MULTI_CLIENT = False
name = str(environ.get('name', 'Dev'))
